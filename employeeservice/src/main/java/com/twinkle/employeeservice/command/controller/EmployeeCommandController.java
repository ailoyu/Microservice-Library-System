package com.twinkle.employeeservice.command.controller;
...
import com.twinkle.employeeservice.command.command.DeleteEmployeeCommand;
import com.twinkle.employeeservice.command.command.UpdateEmployeeCommand;
import com.twinkle.employeeservice.command.model.EmployeeRequestModel;
...
public class EmployeeCommandController {
	...
	public String addEmployee(@RequestBody EmployeeRequestModel model) {
		...
		commandGateway.sendAndWait(command); // Gửi command tới EmployeeAggregate (Command Handler)
	...
	public void SendMessage(@RequestBody String message) {
		try {
			// convert String thành JSON
			ObjectMapper mapper = new ObjectMapper();
			String json = mapper.writeValueAsString(message);
			
			// gửi JSON lên Kafka MessageQueue
